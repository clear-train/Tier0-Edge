...
perl -0pi -e "s|KEYCLOAK_BASE_URL_13020_VAR|$KEYCLOAK_BASE_URL_13020|g" $KEYCLOAK_OUTPUT_FILE
perl -0pi -e "s|KEYCLOAK_BASE_URL_VAR|$KEYCLOAK_BASE_URL|g" $KEYCLOAK_OUTPUT_FILE
perl -0pi -e "s|LANGUAGE_VAR|$LANGUAGE|g" $KEYCLOAK_OUTPUT_FILE
